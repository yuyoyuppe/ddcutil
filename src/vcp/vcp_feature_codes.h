...
typedef bool (*Format_Normal_Feature_Detail_Function)(Nontable_Vcp_Value *   code_info,
                                                      DDCA_MCCS_Version_Spec vcp_version,
                                                      char *                 buffer,
                                                      int                    bufsz);

typedef bool (*Format_Table_Feature_Detail_Function)(Buffer *               data_bytes,
                                                     DDCA_MCCS_Version_Spec vcp_version,
...
void free_synthetic_vcp_entry(VCP_Feature_Table_Entry * vfte);
...
bool has_version_specific_features(VCP_Feature_Table_Entry * vfte);
...
bool is_feature_supported_in_version(VCP_Feature_Table_Entry * vfte, DDCA_MCCS_Version_Spec vcp_version);
...
DDCA_Version_Feature_Flags get_version_specific_feature_flags(VCP_Feature_Table_Entry * vfte,
                                                              DDCA_MCCS_Version_Spec    vcp_version);

DDCA_Version_Feature_Flags get_version_sensitive_feature_flags(VCP_Feature_Table_Entry * vfte,
                                                               DDCA_MCCS_Version_Spec    vcp_version);
...
char * get_feature_name_by_id_only(DDCA_Vcp_Feature_Code feature_code);

char * get_feature_name_by_id_and_vcp_version(DDCA_Vcp_Feature_Code feature_code, DDCA_MCCS_Version_Spec vspec);
...
void report_vcp_feature_table_entry(VCP_Feature_Table_Entry * vfte, int depth);
...
bool vcp_format_feature_detail(VCP_Feature_Table_Entry * vcp_entry,
                               DDCA_MCCS_Version_Spec    vcp_version,
