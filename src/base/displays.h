 ...
 * along with me program; if not, write to the Free Software
...
Display_Identifier * create_mfg_model_sn_display_identifier(const char * mfg_code,
...
bool dref_eq(Display_Ref * me, Display_Ref * that);
