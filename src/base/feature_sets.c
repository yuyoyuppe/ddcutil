...
Value_Name_Table vcp_subset_table = {VNT(VCP_SUBSET_PROFILE, "PROFILE"),
...
char * feature_subset_name(VCP_Feature_Subset subset_id) { return vnt_name(vcp_subset_table, subset_id); }
...
static Value_Name_Title_Table feature_set_flag_table = {VNT(FSF_FORCE, "force"),
...
{
  return vnt_interpret_flags(flags,
